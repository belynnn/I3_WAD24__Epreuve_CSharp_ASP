...
INSERT INTO [dbo].[Utilisateur] ([Email], [MotDePasse], [Pseudo], [DateCreation])
VALUES
    ('john.doe@example.com', '1234', 'JohnDoe', GETDATE()),
    ('jane.smith@example.com', '1234', 'JaneSmith', GETDATE());
